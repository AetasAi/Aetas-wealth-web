...
/
├── index.html               ← Homepage
├── home.html                ← Redirect file (catches /home requests, sends to /)
├── 404.html                 ← Custom 404 page
├── CNAME                    ← Custom domain config (do not edit)
├── README.md                ← This file
│
├── Root-level pages         ← One file per top-level page
...
│   ├── mortgages.html       ← Exists but not linked from main nav (intentional)
│   ├── pensions-retirement.html
│   └── protection-planning.html
│
├── case-studies/            ← Real-client case studies
│   ├── index.html
│   ├── business-owner-exit.html
│   ├── inherited-wealth-clarity.html
│   └── retiring-with-confidence.html
│
├── insights/                ← Blog index and posts
│   ├── index.html           ← Article list with category filter
│   └── posts/               ← Individual articles
│
├── aetas-adeus-life-digital-wills/   ← Partner landing page (adeus Life)
│   └── index.html
│
├── aetas-tls-solicitors/    ← Partner landing page (TLS Solicitors)
│   └── index.html
│
